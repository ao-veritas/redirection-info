...
Handlers.add(
  ...
  function(msg)
    ...
    if (Benchmarks[dataset] == nil) then
      print("Pool " .. dataset .. " does not exist")
      return
    end
    if (Benchmarks[dataset].models[model] ~= nil) then
      print("Model " .. model .. " already joined pool " .. dataset)
      return
    end
...
Handlers.add(
  ...
  function(msg)
    ...
    Handlers.utils.reply(json.encode(pools))(msg)
  end
)
