...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex sm:h-12 h-24 items-center justify-center rounded-lg bg-muted text-muted-foreground px-10",
      className
    )}
    {...props}
  />
