    ...
    >
      <defs>
        ...
        >
          {hovered && (
            <>
              <stop offset="0%" stopColor={"var(--blue-900)"} />
              <stop offset="25%" stopColor={"var(--blue-500)"} />
              <stop offset="50%" stopColor={"var(--violet-900)"} />
      ...
      <motion.text
        ...
        dominantBaseline="middle"
        strokeWidth="0.3"
        className="font-[helvetica] font-bold fill-transparent text-3xl   stroke-cyan-900 dark:stroke-neutral-800"
