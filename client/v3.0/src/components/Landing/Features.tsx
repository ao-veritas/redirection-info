...
const Features = () => {
  return (
    <section className='px-[90px] py-[90px] bg-[#212121] w-full min-h-[90vh]'>
        <div className="grid lg:grid-cols-5 gap-[21px] mx-auto w-full">
            <div className='col-span-2 grid grid-flow-row grid-rows-9 gap-[21px]'>
                <WobbleCard
                containerClassName="h-full bg-[#0E9C9C] min-h-[500px] lg:min-h-[300px] row-span-5 p-0 shadow-[inset_0px_0px_16px_5px_#4a5568]"
                className="py-[36px] "
                >
                ...
                <WobbleCard
                containerClassName="col-span-1 h-full bg-[#0E9C9C] min-h-[500px] lg:min-h-[300px]"
                className="py-[36px]"
                >
            ...
            <div className='col-span-3 grid grid-flow-row grid-rows-9 gap-[21px]'>
                <WobbleCard
                containerClassName="col-span-1 lg:row-span-4 h-full bg-[#0E9C9C] min-h-[500px] lg:min-h-[300px]"
                className="py-[36px]"
                >
                ...
                <div className='row-span-5 grid grid-flow-col grid-cols-5 gap-[21px]'>
                    ...
                    <WobbleCard
                    containerClassName="col-span-1 lg:col-span-2 h-full bg-[#0E9C9C] min-h-[500px] lg:min-h-[300px]"
                    className="py-[36px]"
                    >
