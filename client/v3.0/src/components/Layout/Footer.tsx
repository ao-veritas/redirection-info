...
<footer className="bg-[#151515] w-full border-t-[1px] border-[#212121]">
    <div className="mx-auto w-full py-6 lg:py-8 max-w-[1800px]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-4">
                          <a href="https://flowbite.com/" className="hover:underline">Staking</a>
                      </li>
                      <li className="mb-4">
                          <a href="https://tailwindcss.com/" className="hover:underline">Analysis Dashboard</a>
                      </li>
                      <li>
                          <a href="https://tailwindcss.com/" className="hover:underline">Product Demo</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li className="mb-4">
                          <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Blogs</a>
                      </li>
                      <li>
                          <a href="https://discord.gg/4eeurUVvTy" className="hover:underline">Collaborations</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      ...
                      <li className="mb-4">
                          <a href="#" className="hover:underline">About Team</a>
                      </li>
                      <li >
      ...
      <div className="sm:flex sm:items-center sm:justify-between px-20">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">Veritas</a>. All Rights Reserved.
          </span>
