      ...
      w-full"
        >
          ...
          <h6 className="text-[21px] font-extralight font-sans text-center tracking-widest">
            Get $TAoEth and test out the flow for staking, earning and{" "}
            <span className="block">Permissionless ecosystem funding!</span>
          </h6>
          {connected ? (
            <>
              ...
              <button
                onClick={() => {
                  ...
                  toast.promise(promise, {
                    ...
                    error:
                      "Please wait for some time before requesting an airdrop again!",
                  });
                  promise.finally(() => setLoading(false));
                }}
                disabled={loading}
                className={`z-50 flex gap-4 w-fit ${
                  loading ? "bg-gray-400" : "bg-[#0E9C9C]"
                } 
        ...
        hover:opacity-75 hover:tracking-[3px] hover:px-[20px]`}
            ...
            <>
              ...
              <h2
                className={`text-[27px] leading-[30px] ${brandSecondaryText} font-medium `}
              >
                Please connect wallet to get $tAoETH Tokens
              </h2>
            </>
          )}
        </section>
