-- JxS7fL_reIfaIjr32EIe41RZ4aaJ1UbCnpsRrr7vskk
...
-- PcezQBUQYzIe0nF1hq57VLyWBOyAPm0hWq5vPBrqSq4
...
local function _loaded_mod_token()
    ...
    token.balances = function(msg)
      ...
      Send({ Target = msg.From, Data = "{}", Note = "Feature disabled" }) --sus why (?)
    end
    --[[
         Transfer
       ]]
    ...
    token.transfer = function(msg)
      if MintCount < 100000 then -- mintcount tells the times mint, not amount 
